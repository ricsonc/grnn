...
# 1 view gen but trained on 3 views

# OG('room_3t1view_gen', 'gqn3d_rooms_gen_fixbn', NUM_VIEWS=1)
# OG('metzler_3t1view_gen', 'gqn3d_sm_gen', NUM_VIEWS=1, load_name='sm_fix_bn')
# OG('shapenet_3t1view_gen', 'gqn3d_shapenet_gen', NUM_VIEWS=1, load_name = 'shapenet_fixbn')
# OG('shapenet4_3t1view_gen', 'shapenet_3t1view_gen', '4_data', data_dir='4_tfrs', load_name = 'shapenet_fixbn')

# OG('room_3t2view_gen', 'gqn3d_rooms_gen_fixbn', NUM_VIEWS=2)
# OG('metzler_3t2view_gen', 'gqn3d_sm_gen', NUM_VIEWS=2, load_name='sm_fix_bn')
# OG('shapenet_3t2view_gen', 'gqn3d_shapenet_gen', NUM_VIEWS=2, load_name = 'shapenet_fixbn')
# OG('shapenet4_3t2view_gen', 'shapenet_3t2view_gen', '4_data', data_dir='4_tfrs', load_name = 'shapenet_fixbn')

###########################################################################################
# these will be discarded soon
...
OG('tower_metzler_eval', 'gqntower_deepmind_eval', load_name='tower_metzler_trained')
OG('tower_metzler_gen', 'gqntower_sm_gen', load_name='tower_metzler_trained')

OG('tower_rooms_eval', 'gqntower_room_eval', load_name='tower_rooms_trained')
OG('tower_rooms_gen', 'gqntower_rooms_gen', load_name='tower_rooms_trained')

OG('tower_shapenet_eval', 'gqntower2_eval', load_name='tower_shapenet_trained')
OG('tower_shapenet_gen', 'gqntower_shapenet_gen', load_name='tower_shapenet_trained')

OG('tower_shapenet4_eval', 'gqntower_4obj_eval', load_name='tower_shapenet_trained')
OG('tower_shapenet4_gen', 'gqntower_shapenet4_gen', load_name='tower_shapenet_trained')

OG('tower_arith_eval', 'arith2', load_name='tower_shapenet_trained') 

##

OG('grnn_metzler_eval', 'gqn3d_deepmind_eval', load_name='grnn_metzler_trained')
OG('grnn_metzler_gen', 'gqn3d_sm_gen', load_name='grnn_metzler_trained')

OG('grnn_rooms_eval', 'gqn3d_rooms6_eval', load_name='grnn_rooms_trained')
OG('grnn_rooms_gen', 'gqn3d_rooms_gen', load_name='grnn_rooms_trained')

OG('grnn_shapenet_eval', 'gqn3d_convlstm_big_eval', load_name='grnn_shapenet_trained')
OG('grnn_shapenet_gen', 'gqn3d_shapenet_gen', load_name='grnn_shapenet_trained')

OG('grnn_shapenet4_eval', 'gqn3d_convlstm_4obj_eval', load_name='grnn_shapenet_trained')
OG('grnn_shapenet4_gen', 'gqn3d_shapenet4_gen', load_name='grnn_shapenet_trained')

OG('grnn_arith_eval', 'arith', load_name='grnn_shapenet_trained')
